...
const FlipImage3 = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen pt-[150px] bg-[#845EC2]">
      <motion.div
      ...
      >
        ...
        >
          <Image
            src="/image5.png" // Replace with actual image path
            alt="Front"
            width={500}
            height={500}
        ...
        >
          <Image
            src="/image6.png" // Replace with actual image path
            alt="Back"
            width={500}
            height={500}
            className="rounded-lg floating"
